...
( function() {
	...
	function createDialog() {
		...
		const tokenUrlInput = "https://81045.cke-cs.com/token/dev/70b93e183064297b6aab328cef74abfd13195b6d24d1e5177c7f3a4dfb3f";//document.getElementById( 'token-url' );
		const uploadUrlInput = "https://81045.cke-cs.com/easyimage/upload/";//document.getElementById( 'upload-url' );
		const webSocketUrlInput = "wss://81045.cke-cs.com/ws";// document.getElementById( 'web-socket-url' );
		const channelIdInput = "7276";//document.getElementById( 'channel-id' );
		const additional = "234";//document.getElementById( 'additional' );
